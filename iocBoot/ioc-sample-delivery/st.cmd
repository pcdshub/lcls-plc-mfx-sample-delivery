...
#
#         Project: lcls-plc-mfx-sample-delivery.tsproj
...
#     PLC IP/host: 172.21.72.113
#      PLC Net ID: 172.21.72.113.1.1
...
epicsEnvSet("IPADDR",           "172.21.72.113")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.72.113 ^172.*$")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:sample_delivery,PROJECT=lcls-plc-mfx-sample-delivery.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.72.113")
